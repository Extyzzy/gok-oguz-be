...
export class NonWorkingDaysController {
  ...
  async createDateByDate(
    ...
    console.log(
      'non-working-days.controller.ts - createDateByDate() - date: ',
      date,
      ', num: ',
      num,
    );
  ...
  async getRecBeforeDate(@Param('date') date: string) {
    ...
    console.log(
      'non-working-days.controller.ts - getRecBeforeDate() - date: ',
      date,
    );
  ...
  async updateRecordById(
    ...
    console.log(
      `non-working-days.controller.ts - updateRecordById() - id: ${id}, newDate: ${newDate}, numberOfDays: ${numberOfDays}`,
    );

    return this.nonWorkingDaysService.updateRecordById(
      id,
      newDate,
      numberOfDays,
    );
  ...
  async updateRecordByDate(
    ...
    console.log(
      `non-working-days.controller.ts - updateRecordByDate() - date: ${date}, newDate: ${newDate}, numberOfDays: ${numberOfDays}`,
    );

    return this.nonWorkingDaysService.updateRecordByDate(
      date,
      newDate,
      numberOfDays,
    );
  ...
  async deleteRecordByName(@Param('id') id: number) {
    ...
    console.log(
      `non-working-days.controller.ts - deleteRecordByName() - id: ${id}`,
    );
